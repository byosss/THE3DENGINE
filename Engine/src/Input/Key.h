...
namespace MOUSE {
    ...
    const int LEFT = GLFW_MOUSE_BUTTON_LEFT;
    const int RIGHT = GLFW_MOUSE_BUTTON_RIGHT;
    const int MIDDLE = GLFW_MOUSE_BUTTON_MIDDLE;
    const int FOUR = GLFW_MOUSE_BUTTON_4;
    const int FIVE = GLFW_MOUSE_BUTTON_5;

    const int LAST = GLFW_MOUSE_BUTTON_LAST;
}
