...
void Scene::addChild(Object* parent, Object* child) {
    if (parent != nullptr && child != nullptr) {
        ...
        else if (dynamic_cast<DirectionalLight*>(child) != nullptr) {
            dirLights.push_back(dynamic_cast<DirectionalLight*>(child));
        }
        else if (dynamic_cast<SpotLight*>(child) != nullptr) {
            spotLights.push_back(dynamic_cast<SpotLight*>(child));
        }
    }
}
